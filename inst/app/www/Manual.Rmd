...
MetaboReport accepts a variety of outputs generated from different software tools, such as **XCMS**, **MSDIAL**, and **Compound Discoverer**. The output table can be submitted to MetaboReport with very little modification.

Lkke any other software tools, Metaboreport requires at least two pieces of information for metabolomics data analysis, i.e., **Peak area** and **sample metadata**.
...
An example is used here to demonstrate how to prepare the input data table for MetaboReport. 

Suppose you want to compare the metabolic profiles between a group of wild type (**WT**) and Mutant (**MU**) mice; `WT` and `MU` will be the metadata, meaning each sample is labeled with either a **WT** or **Mu** metadata. 
...
In order to evaluate any variations, you introduced a set of pooled QC (`QC`) samples in your study.
...
The most common mistakes you will encounter during data analysis using MetaboReport is the data format issue. 
